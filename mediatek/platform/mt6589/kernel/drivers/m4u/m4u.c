...
static int m4u_manual_insert_entry(M4U_PORT_ID_ENUM eModuleID,
									...
									int Lock);
static int m4u_reset_mva_release_tlb(M4U_MODULE_ID_ENUM eModuleID);
...
static unsigned int m4u_index_of_larb[SMI_LARB_NR] = {0,0,0,0,1};
static unsigned int m4u_index_of_larb5 = 0,  m4u_index_of_larb6 = 1;
