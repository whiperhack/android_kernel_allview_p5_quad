...
typedef struct _MPEG4_VOL_HDR_FIELD_T
{
	...
	UINT32      fgInterlaced           :  1;               ///< When set to \A1\A71\A1\A8 indicates that the VOP may contain interlaced video.
...
{    
    ...
    BOOL        fgRandAccVol;           ///< flag may be set to \A1\A71\A1\A8 to indicate that every VOP in this VOL is individually decodable.
