...
const NVRAM_LENS_PARA_STRUCT A5142AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 A5142AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &A5142AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pA5142AF_getDefaultData = A5142AF_getDefaultData;
