...
void S5K5CAGX_Initialize_Setting(void)
{
	...
	*/
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F0); //0100 #TVAR_ash_GASAlpha[20]//D65
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B6); //01C8#TVAR_ash_pGAS[0]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C6); //018F#TVAR_ash_pGAS[1]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D9); //014E#TVAR_ash_pGAS[2]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C3); //011B#TVAR_ash_pGAS[3]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B4); //00F4#TVAR_ash_pGAS[4]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A8); //00DE#TVAR_ash_pGAS[5]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009F); //00D4#TVAR_ash_pGAS[6]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009F); //00DA#TVAR_ash_pGAS[7]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A8); //00F3#TVAR_ash_pGAS[8]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BB); //011D#TVAR_ash_pGAS[9]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D3); //0156#TVAR_ash_pGAS[10]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CF); //019D#TVAR_ash_pGAS[11]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A2); //01DF#TVAR_ash_pGAS[12]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A5); //019E#TVAR_ash_pGAS[13]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C9); //015C#TVAR_ash_pGAS[14]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AE); //0114#TVAR_ash_pGAS[15]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0095); //00D9#TVAR_ash_pGAS[16]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0083); //00AF#TVAR_ash_pGAS[17]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0075); //0096#TVAR_ash_pGAS[18]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D); //008D#TVAR_ash_pGAS[19]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006E); //0094#TVAR_ash_pGAS[20]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0078); //00AE#TVAR_ash_pGAS[21]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008C); //00DC#TVAR_ash_pGAS[22]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AC); //011B#TVAR_ash_pGAS[23]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D4); //0168#TVAR_ash_pGAS[24]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0); //01B5#TVAR_ash_pGAS[25]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B7); //0169#TVAR_ash_pGAS[26]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AC); //0124#TVAR_ash_pGAS[27]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008A); //00D5#TVAR_ash_pGAS[28]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006E); //0099#TVAR_ash_pGAS[29]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0059); //006E#TVAR_ash_pGAS[30]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0048); //0055#TVAR_ash_pGAS[31]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003E); //004B#TVAR_ash_pGAS[32]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0054#TVAR_ash_pGAS[33]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0051); //0070#TVAR_ash_pGAS[34]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006A); //009F#TVAR_ash_pGAS[35]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0088); //00DF#TVAR_ash_pGAS[36]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B6); //0134#TVAR_ash_pGAS[37]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D0); //0183#TVAR_ash_pGAS[38]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AE); //0145#TVAR_ash_pGAS[39]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0092); //00F8#TVAR_ash_pGAS[40]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D); //00A9#TVAR_ash_pGAS[41]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0051); //006C#TVAR_ash_pGAS[42]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0036); //0042#TVAR_ash_pGAS[43]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025); //0029#TVAR_ash_pGAS[44]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001C); //0020#TVAR_ash_pGAS[45]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0021); //0029#TVAR_ash_pGAS[46]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033); //0045#TVAR_ash_pGAS[47]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050); //0074#TVAR_ash_pGAS[48]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070); //00B5#TVAR_ash_pGAS[49]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009D); //010D#TVAR_ash_pGAS[50]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C8); //015F#TVAR_ash_pGAS[51]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A3); //012B#TVAR_ash_pGAS[52]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0082); //00DD#TVAR_ash_pGAS[53]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B); //008E#TVAR_ash_pGAS[54]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003B); //0051#TVAR_ash_pGAS[55]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F); //0028#TVAR_ash_pGAS[56]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000E); //0010#TVAR_ash_pGAS[57]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0007); //0007#TVAR_ash_pGAS[58]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000B); //0011#TVAR_ash_pGAS[59]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001C); //002C#TVAR_ash_pGAS[60]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003A); //005C#TVAR_ash_pGAS[61]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060); //009F#TVAR_ash_pGAS[62]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090); //00F6#TVAR_ash_pGAS[63]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BD); //014D#TVAR_ash_pGAS[64]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009D); //0122#TVAR_ash_pGAS[65]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C); //00D3#TVAR_ash_pGAS[66]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0054); //0083#TVAR_ash_pGAS[67]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0031); //0047#TVAR_ash_pGAS[68]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016); //001E#TVAR_ash_pGAS[69]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0005); //0007#TVAR_ash_pGAS[70]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //0000#TVAR_ash_pGAS[71]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); //0009#TVAR_ash_pGAS[72]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013); //0025#TVAR_ash_pGAS[73]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //0056#TVAR_ash_pGAS[74]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057); //0099#TVAR_ash_pGAS[75]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0084); //00F0#TVAR_ash_pGAS[76]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B6); //0149#TVAR_ash_pGAS[77]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009F); //0129#TVAR_ash_pGAS[78]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007E); //00DC#TVAR_ash_pGAS[79]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057); //008C#TVAR_ash_pGAS[80]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034); //0050#TVAR_ash_pGAS[81]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019); //0027#TVAR_ash_pGAS[82]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008); //000F#TVAR_ash_pGAS[83]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); //0009#TVAR_ash_pGAS[84]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0006); //0012#TVAR_ash_pGAS[85]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0017); //002E#TVAR_ash_pGAS[86]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034); //0060#TVAR_ash_pGAS[87]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B); //00A3#TVAR_ash_pGAS[88]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0089); //00FC#TVAR_ash_pGAS[89]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B7); //0154#TVAR_ash_pGAS[90]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AE); //013F#TVAR_ash_pGAS[91]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008B); //00F4#TVAR_ash_pGAS[92]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0065); //00A6#TVAR_ash_pGAS[93]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0044); //006A#TVAR_ash_pGAS[94]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029); //0040#TVAR_ash_pGAS[95]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0018); //0029#TVAR_ash_pGAS[96]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000F); //0021#TVAR_ash_pGAS[97]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014); //002B#TVAR_ash_pGAS[98]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026); //004A#TVAR_ash_pGAS[99]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0044); //007B#TVAR_ash_pGAS[100]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069); //00BF#TVAR_ash_pGAS[101]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009A); //0118#TVAR_ash_pGAS[102]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C6); //016C#TVAR_ash_pGAS[103]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B7); //0163#TVAR_ash_pGAS[104]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009E); //011C#TVAR_ash_pGAS[105]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007A); //00D0#TVAR_ash_pGAS[106]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005C); //0095#TVAR_ash_pGAS[107]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0043); //006C#TVAR_ash_pGAS[108]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0031); //0054#TVAR_ash_pGAS[109]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029); //004C#TVAR_ash_pGAS[110]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002F); //0057#TVAR_ash_pGAS[111]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0075#TVAR_ash_pGAS[112]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005F); //00A8#TVAR_ash_pGAS[113]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0081); //00EB#TVAR_ash_pGAS[114]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B0); //0141#TVAR_ash_pGAS[115]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D7); //0190#TVAR_ash_pGAS[116]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BD); //0191#TVAR_ash_pGAS[117]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B9); //0154#TVAR_ash_pGAS[118]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0096); //010E#TVAR_ash_pGAS[119]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007B); //00D5#TVAR_ash_pGAS[120]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0063); //00AD#TVAR_ash_pGAS[121]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0054); //0096#TVAR_ash_pGAS[122]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //0090#TVAR_ash_pGAS[123]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0053); //009A#TVAR_ash_pGAS[124]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0066); //00B6#TVAR_ash_pGAS[125]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080); //00E9#TVAR_ash_pGAS[126]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A2); //012C#TVAR_ash_pGAS[127]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D3); //017D#TVAR_ash_pGAS[128]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E5); //01C7#TVAR_ash_pGAS[129]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AB); //01C1#TVAR_ash_pGAS[130]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D1); //0183#TVAR_ash_pGAS[131]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BB); //0146#TVAR_ash_pGAS[132]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A1); //0114#TVAR_ash_pGAS[133]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008F); //00EC#TVAR_ash_pGAS[134]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0083); //00D8#TVAR_ash_pGAS[135]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C); //00D4#TVAR_ash_pGAS[136]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0081); //00DC#TVAR_ash_pGAS[137]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090); //00F7#TVAR_ash_pGAS[138]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A5); //0126#TVAR_ash_pGAS[139]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C4); //0164#TVAR_ash_pGAS[140]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E4); //01AB#TVAR_ash_pGAS[141]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C9); //01F6#TVAR_ash_pGAS[142]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0083); //016D#TVAR_ash_pGAS[143]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008A); //013B#TVAR_ash_pGAS[144]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009C); //0106#TVAR_ash_pGAS[145]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008C); //00DA#TVAR_ash_pGAS[146]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080); //00B8#TVAR_ash_pGAS[147]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0077); //00A4#TVAR_ash_pGAS[148]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0071); //009B#TVAR_ash_pGAS[149]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070); //00A1#TVAR_ash_pGAS[150]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0076); //00B4#TVAR_ash_pGAS[151]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0081); //00D4#TVAR_ash_pGAS[152]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008F); //0100#TVAR_ash_pGAS[153]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0084); //0135#TVAR_ash_pGAS[154]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A); //0173#TVAR_ash_pGAS[155]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D); //014E#TVAR_ash_pGAS[156]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008D); //0111#TVAR_ash_pGAS[157]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0079); //00D5#TVAR_ash_pGAS[158]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069); //00A6#TVAR_ash_pGAS[159]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B); //0083#TVAR_ash_pGAS[160]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050); //006E#TVAR_ash_pGAS[161]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C); //0066#TVAR_ash_pGAS[162]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004D); //006D#TVAR_ash_pGAS[163]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0053); //0080#TVAR_ash_pGAS[164]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D); //00A0#TVAR_ash_pGAS[165]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070); //00CF#TVAR_ash_pGAS[166]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008C); //010C#TVAR_ash_pGAS[167]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007A); //014F#TVAR_ash_pGAS[168]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0082); //0127#TVAR_ash_pGAS[169]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0079); //00E7#TVAR_ash_pGAS[170]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0061); //00A6#TVAR_ash_pGAS[171]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //0075#TVAR_ash_pGAS[172]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F); //0052#TVAR_ash_pGAS[173]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033); //003E#TVAR_ash_pGAS[174]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C); //0038#TVAR_ash_pGAS[175]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002E); //003E#TVAR_ash_pGAS[176]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0039); //0052#TVAR_ash_pGAS[177]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0048); //0074#TVAR_ash_pGAS[178]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A); //00A3#TVAR_ash_pGAS[179]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0078); //00E4#TVAR_ash_pGAS[180]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0089); //0129#TVAR_ash_pGAS[181]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0079); //0107#TVAR_ash_pGAS[182]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0066); //00C4#TVAR_ash_pGAS[183]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004D); //0083#TVAR_ash_pGAS[184]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003A); //0053#TVAR_ash_pGAS[185]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026); //0032#TVAR_ash_pGAS[186]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019); //001E#TVAR_ash_pGAS[187]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014); //0018#TVAR_ash_pGAS[188]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0018); //0020#TVAR_ash_pGAS[189]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025); //0034#TVAR_ash_pGAS[190]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0037); //0056#TVAR_ash_pGAS[191]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004A); //0086#TVAR_ash_pGAS[192]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0065); //00C7#TVAR_ash_pGAS[193]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0084); //010D#TVAR_ash_pGAS[194]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070); //00F2#TVAR_ash_pGAS[195]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0059); //00AE#TVAR_ash_pGAS[196]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //006E#TVAR_ash_pGAS[197]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A); //003E#TVAR_ash_pGAS[198]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016); //001E#TVAR_ash_pGAS[199]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008); //000B#TVAR_ash_pGAS[200]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0005); //0006#TVAR_ash_pGAS[201]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0009); //000E#TVAR_ash_pGAS[202]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016); //0023#TVAR_ash_pGAS[203]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A); //0044#TVAR_ash_pGAS[204]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0075#TVAR_ash_pGAS[205]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005F); //00B6#TVAR_ash_pGAS[206]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007D); //00FF#TVAR_ash_pGAS[207]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006B); //00E8#TVAR_ash_pGAS[208]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0054); //00A5#TVAR_ash_pGAS[209]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003A); //0065#TVAR_ash_pGAS[210]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023); //0037#TVAR_ash_pGAS[211]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0010); //0017#TVAR_ash_pGAS[212]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); //0005#TVAR_ash_pGAS[213]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //0000#TVAR_ash_pGAS[214]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004); //0009#TVAR_ash_pGAS[215]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0010); //001E#TVAR_ash_pGAS[216]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025); //0040#TVAR_ash_pGAS[217]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003D); //0071#TVAR_ash_pGAS[218]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0058); //00B3#TVAR_ash_pGAS[219]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007A); //00FC#TVAR_ash_pGAS[220]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006B); //00EC#TVAR_ash_pGAS[221]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0054); //00A9#TVAR_ash_pGAS[222]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //006A#TVAR_ash_pGAS[223]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025); //003C#TVAR_ash_pGAS[224]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0012); //001D#TVAR_ash_pGAS[225]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0005); //000B#TVAR_ash_pGAS[226]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); //0007#TVAR_ash_pGAS[227]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0007); //0010#TVAR_ash_pGAS[228]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0015); //0026#TVAR_ash_pGAS[229]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029); //0048#TVAR_ash_pGAS[230]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0079#TVAR_ash_pGAS[231]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D); //00BB#TVAR_ash_pGAS[232]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C); //0103#TVAR_ash_pGAS[233]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0076); //00FC#TVAR_ash_pGAS[234]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D); //00BB#TVAR_ash_pGAS[235]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0045); //007D#TVAR_ash_pGAS[236]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //004F#TVAR_ash_pGAS[237]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001D); //0030#TVAR_ash_pGAS[238]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0011); //001E#TVAR_ash_pGAS[239]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000D); //001A#TVAR_ash_pGAS[240]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0012); //0024#TVAR_ash_pGAS[241]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0020); //003B#TVAR_ash_pGAS[242]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034); //005E#TVAR_ash_pGAS[243]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004B); //008F#TVAR_ash_pGAS[244]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069); //00D1#TVAR_ash_pGAS[245]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0089); //0117#TVAR_ash_pGAS[246]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007E); //0116#TVAR_ash_pGAS[247]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D); //00D9#TVAR_ash_pGAS[248]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0055); //009C#TVAR_ash_pGAS[249]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042); //006E#TVAR_ash_pGAS[250]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //004F#TVAR_ash_pGAS[251]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026); //003E#TVAR_ash_pGAS[252]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0022); //003A#TVAR_ash_pGAS[253]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028); //0045#TVAR_ash_pGAS[254]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0035); //005C#TVAR_ash_pGAS[255]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049); //007F#TVAR_ash_pGAS[256]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D); //00B0#TVAR_ash_pGAS[257]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C); //00F2#TVAR_ash_pGAS[258]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0097); //0135#TVAR_ash_pGAS[259]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080); //0139#TVAR_ash_pGAS[260]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080); //0101#TVAR_ash_pGAS[261]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0067); //00C9#TVAR_ash_pGAS[262]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057); //009D#TVAR_ash_pGAS[263]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0048); //007F#TVAR_ash_pGAS[264]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //006D#TVAR_ash_pGAS[265]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003E); //006A#TVAR_ash_pGAS[266]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0044); //0075#TVAR_ash_pGAS[267]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0052); //008C#TVAR_ash_pGAS[268]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062); //00B1#TVAR_ash_pGAS[269]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0079); //00E2#TVAR_ash_pGAS[270]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009B); //0120#TVAR_ash_pGAS[271]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A6); //0160#TVAR_ash_pGAS[272]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006E); //0160#TVAR_ash_pGAS[273]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008F); //012A#TVAR_ash_pGAS[274]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080); //00F9#TVAR_ash_pGAS[275]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D); //00CF#TVAR_ash_pGAS[276]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0063); //00B1#TVAR_ash_pGAS[277]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D); //00A0#TVAR_ash_pGAS[278]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005C); //009D#TVAR_ash_pGAS[279]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062); //00A9#TVAR_ash_pGAS[280]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D); //00C1#TVAR_ash_pGAS[281]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007B); //00E6#TVAR_ash_pGAS[282]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008F); //0113#TVAR_ash_pGAS[283]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A6); //014C#TVAR_ash_pGAS[284]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008B); //018E#TVAR_ash_pGAS[285]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0074); //016A#TVAR_ash_pGAS[286]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0085); //0137#TVAR_ash_pGAS[287]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0098); //0102#TVAR_ash_pGAS[288]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0088); //00D6#TVAR_ash_pGAS[289]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007F); //00B5#TVAR_ash_pGAS[290]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007B); //00A3#TVAR_ash_pGAS[291]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007A); //009E#TVAR_ash_pGAS[292]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007E); //00A9#TVAR_ash_pGAS[293]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008B); //00C3#TVAR_ash_pGAS[294]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009C); //00EA#TVAR_ash_pGAS[295]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AD); //011A#TVAR_ash_pGAS[296]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A5); //0155#TVAR_ash_pGAS[297]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0074); //0191#TVAR_ash_pGAS[298]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006B); //014D#TVAR_ash_pGAS[299]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008C); //010F#TVAR_ash_pGAS[300]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0078); //00D3#TVAR_ash_pGAS[301]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069); //00A3#TVAR_ash_pGAS[302]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005E); //0082#TVAR_ash_pGAS[303]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0056); //006E#TVAR_ash_pGAS[304]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0056); //006A#TVAR_ash_pGAS[305]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B); //0075#TVAR_ash_pGAS[306]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0067); //008E#TVAR_ash_pGAS[307]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0077); //00B4#TVAR_ash_pGAS[308]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008E); //00E8#TVAR_ash_pGAS[309]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B0); //0127#TVAR_ash_pGAS[310]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009C); //016F#TVAR_ash_pGAS[311]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0086); //0126#TVAR_ash_pGAS[312]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007D); //00E5#TVAR_ash_pGAS[313]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0064); //00A5#TVAR_ash_pGAS[314]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0052); //0075#TVAR_ash_pGAS[315]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0044); //0053#TVAR_ash_pGAS[316]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003A); //0040#TVAR_ash_pGAS[317]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0036); //003B#TVAR_ash_pGAS[318]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //0045#TVAR_ash_pGAS[319]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C); //005E#TVAR_ash_pGAS[320]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060); //0084#TVAR_ash_pGAS[321]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0077); //00B8#TVAR_ash_pGAS[322]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0099); //00FB#TVAR_ash_pGAS[323]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AB); //0142#TVAR_ash_pGAS[324]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0083); //0108#TVAR_ash_pGAS[325]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D); //00C6#TVAR_ash_pGAS[326]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0054); //0085#TVAR_ash_pGAS[327]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0055#TVAR_ash_pGAS[328]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D); //0033#TVAR_ash_pGAS[329]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0020); //0020#TVAR_ash_pGAS[330]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001C); //001B#TVAR_ash_pGAS[331]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023); //0025#TVAR_ash_pGAS[332]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0035); //003D#TVAR_ash_pGAS[333]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C); //0062#TVAR_ash_pGAS[334]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0063); //0095#TVAR_ash_pGAS[335]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0082); //00D9#TVAR_ash_pGAS[336]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A2); //011F#TVAR_ash_pGAS[337]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007E); //00F5#TVAR_ash_pGAS[338]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0065); //00B0#TVAR_ash_pGAS[339]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004B); //0071#TVAR_ash_pGAS[340]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034); //0042#TVAR_ash_pGAS[341]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //0021#TVAR_ash_pGAS[342]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0010); //000D#TVAR_ash_pGAS[343]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000D); //0007#TVAR_ash_pGAS[344]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013); //0011#TVAR_ash_pGAS[345]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023); //0028#TVAR_ash_pGAS[346]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003B); //004C#TVAR_ash_pGAS[347]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0055); //007E#TVAR_ash_pGAS[348]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0076); //00C0#TVAR_ash_pGAS[349]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0095); //0108#TVAR_ash_pGAS[350]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007F); //00EE#TVAR_ash_pGAS[351]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0065); //00AB#TVAR_ash_pGAS[352]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049); //006A#TVAR_ash_pGAS[353]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //003B#TVAR_ash_pGAS[354]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001A); //001A#TVAR_ash_pGAS[355]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A); //0006#TVAR_ash_pGAS[356]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0006); //0000#TVAR_ash_pGAS[357]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000B); //0009#TVAR_ash_pGAS[358]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001A); //0020#TVAR_ash_pGAS[359]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0031); //0043#TVAR_ash_pGAS[360]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C); //0074#TVAR_ash_pGAS[361]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0068); //00B5#TVAR_ash_pGAS[362]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008C); //00FC#TVAR_ash_pGAS[363]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0083); //00F4#TVAR_ash_pGAS[364]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0068); //00B2#TVAR_ash_pGAS[365]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //0072#TVAR_ash_pGAS[366]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034); //0043#TVAR_ash_pGAS[367]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //0021#TVAR_ash_pGAS[368]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000D); //000C#TVAR_ash_pGAS[369]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008); //0006#TVAR_ash_pGAS[370]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000C); //000E#TVAR_ash_pGAS[371]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001B); //0023#TVAR_ash_pGAS[372]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //0046#TVAR_ash_pGAS[373]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049); //0075#TVAR_ash_pGAS[374]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0065); //00B6#TVAR_ash_pGAS[375]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0086); //00FC#TVAR_ash_pGAS[376]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0091); //0108#TVAR_ash_pGAS[377]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0074); //00C7#TVAR_ash_pGAS[378]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A); //0088#TVAR_ash_pGAS[379]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0057#TVAR_ash_pGAS[380]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A); //0034#TVAR_ash_pGAS[381]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001A); //001F#TVAR_ash_pGAS[382]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013); //0018#TVAR_ash_pGAS[383]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0015); //001F#TVAR_ash_pGAS[384]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023); //0034#TVAR_ash_pGAS[385]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0036); //0057#TVAR_ash_pGAS[386]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004D); //0085#TVAR_ash_pGAS[387]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006A); //00C5#TVAR_ash_pGAS[388]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008C); //010A#TVAR_ash_pGAS[389]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009B); //0125#TVAR_ash_pGAS[390]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0086); //00E5#TVAR_ash_pGAS[391]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006C); //00A8#TVAR_ash_pGAS[392]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0055); //0078#TVAR_ash_pGAS[393]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //0055#TVAR_ash_pGAS[394]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002F); //003F#TVAR_ash_pGAS[395]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0027); //0037#TVAR_ash_pGAS[396]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029); //003E#TVAR_ash_pGAS[397]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034); //0052#TVAR_ash_pGAS[398]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046); //0074#TVAR_ash_pGAS[399]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0058); //00A2#TVAR_ash_pGAS[400]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0075); //00E0#TVAR_ash_pGAS[401]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0092); //0122#TVAR_ash_pGAS[402]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A0); //0149#TVAR_ash_pGAS[403]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009A); //0110#TVAR_ash_pGAS[404]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007E); //00D7#TVAR_ash_pGAS[405]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006A); //00A8#TVAR_ash_pGAS[406]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057); //0085#TVAR_ash_pGAS[407]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049); //006F#TVAR_ash_pGAS[408]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042); //0067#TVAR_ash_pGAS[409]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0043); //006E#TVAR_ash_pGAS[410]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004D); //0081#TVAR_ash_pGAS[411]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A); //00A2#TVAR_ash_pGAS[412]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006E); //00CF#TVAR_ash_pGAS[413]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008E); //0108#TVAR_ash_pGAS[414]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009B); //014A#TVAR_ash_pGAS[415]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x008F); //0178#TVAR_ash_pGAS[416]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AB); //013B#TVAR_ash_pGAS[417]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x009B); //0109#TVAR_ash_pGAS[418]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0084); //00DE#TVAR_ash_pGAS[419]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0075); //00BB#TVAR_ash_pGAS[420]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069); //00A5#TVAR_ash_pGAS[421]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0061); //009C#TVAR_ash_pGAS[422]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0061); //00A2#TVAR_ash_pGAS[423]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0067); //00B4#TVAR_ash_pGAS[424]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0071); //00D5#TVAR_ash_pGAS[425]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0081); //00FD#TVAR_ash_pGAS[426]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0095); //0133#TVAR_ash_pGAS[427]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x007F); //0177#TVAR_ash_pGAS[428]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F); //012B#TVAR_ash_pGAS[429]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0056); //0103#TVAR_ash_pGAS[430]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069); //00D5#TVAR_ash_pGAS[431]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005F); //00B4#TVAR_ash_pGAS[432]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B); //009D#TVAR_ash_pGAS[433]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A); //0090#TVAR_ash_pGAS[434]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057); //008E#TVAR_ash_pGAS[435]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0058); //0098#TVAR_ash_pGAS[436]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D); //00AC#TVAR_ash_pGAS[437]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0067); //00CE#TVAR_ash_pGAS[438]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0071); //00FA#TVAR_ash_pGAS[439]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060); //0131#TVAR_ash_pGAS[440]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029); //0166#TVAR_ash_pGAS[441]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0038); //0110#TVAR_ash_pGAS[442]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060); //00DA#TVAR_ash_pGAS[443]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0052); //00A8#TVAR_ash_pGAS[444]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004A); //0084#TVAR_ash_pGAS[445]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0045); //006C#TVAR_ash_pGAS[446]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042); //0060#TVAR_ash_pGAS[447]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //005E#TVAR_ash_pGAS[448]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0068#TVAR_ash_pGAS[449]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046); //007B#TVAR_ash_pGAS[450]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C); //009C#TVAR_ash_pGAS[451]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B); //00CB#TVAR_ash_pGAS[452]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0074); //0105#TVAR_ash_pGAS[453]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0058); //0146#TVAR_ash_pGAS[454]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //00E6#TVAR_ash_pGAS[455]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050); //00B2#TVAR_ash_pGAS[456]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //007F#TVAR_ash_pGAS[457]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0036); //005A#TVAR_ash_pGAS[458]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //0043#TVAR_ash_pGAS[459]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002B); //0038#TVAR_ash_pGAS[460]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028); //0035#TVAR_ash_pGAS[461]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A); //003D#TVAR_ash_pGAS[462]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //0051#TVAR_ash_pGAS[463]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003D); //0070#TVAR_ash_pGAS[464]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049); //009C#TVAR_ash_pGAS[465]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062); //00D9#TVAR_ash_pGAS[466]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0065); //011A#TVAR_ash_pGAS[467]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004A); //00C9#TVAR_ash_pGAS[468]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //0093#TVAR_ash_pGAS[469]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //0060#TVAR_ash_pGAS[470]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028); //003D#TVAR_ash_pGAS[471]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001D); //0027#TVAR_ash_pGAS[472]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0017); //001C#TVAR_ash_pGAS[473]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014); //0019#TVAR_ash_pGAS[474]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0017); //0021#TVAR_ash_pGAS[475]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0022); //0033#TVAR_ash_pGAS[476]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002F); //0051#TVAR_ash_pGAS[477]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003A); //007B#TVAR_ash_pGAS[478]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //00B6#TVAR_ash_pGAS[479]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005E); //00F6#TVAR_ash_pGAS[480]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041); //00B4#TVAR_ash_pGAS[481]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0037); //007E#TVAR_ash_pGAS[482]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026); //004C#TVAR_ash_pGAS[483]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001C); //002A#TVAR_ash_pGAS[484]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000F); //0015#TVAR_ash_pGAS[485]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0009); //000A#TVAR_ash_pGAS[486]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0007); //0007#TVAR_ash_pGAS[487]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0009); //000E#TVAR_ash_pGAS[488]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0012); //001F#TVAR_ash_pGAS[489]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F); //003A#TVAR_ash_pGAS[490]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002F); //0064#TVAR_ash_pGAS[491]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0044); //009D#TVAR_ash_pGAS[492]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0053); //00DC#TVAR_ash_pGAS[493]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003D); //00AE#TVAR_ash_pGAS[494]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033); //0076#TVAR_ash_pGAS[495]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0022); //0045#TVAR_ash_pGAS[496]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0015); //0024#TVAR_ash_pGAS[497]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A); //000E#TVAR_ash_pGAS[498]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); //0003#TVAR_ash_pGAS[499]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001); //0000#TVAR_ash_pGAS[500]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); //0006#TVAR_ash_pGAS[501]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A); //0016#TVAR_ash_pGAS[502]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016); //0031#TVAR_ash_pGAS[503]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025); //0059#TVAR_ash_pGAS[504]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0036); //0091#TVAR_ash_pGAS[505]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0047); //00CF#TVAR_ash_pGAS[506]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //00B2#TVAR_ash_pGAS[507]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034); //007C#TVAR_ash_pGAS[508]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026); //004B#TVAR_ash_pGAS[509]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019); //0029#TVAR_ash_pGAS[510]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000D); //0014#TVAR_ash_pGAS[511]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0005); //0008#TVAR_ash_pGAS[512]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); //0004#TVAR_ash_pGAS[513]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); //000A#TVAR_ash_pGAS[514]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0009); //0019#TVAR_ash_pGAS[515]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013); //0033#TVAR_ash_pGAS[516]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0020); //005A#TVAR_ash_pGAS[517]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //0090#TVAR_ash_pGAS[518]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F); //00CE#TVAR_ash_pGAS[519]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C); //00C3#TVAR_ash_pGAS[520]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003E); //008E#TVAR_ash_pGAS[521]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002F); //005D#TVAR_ash_pGAS[522]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023); //003B#TVAR_ash_pGAS[523]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0018); //0024#TVAR_ash_pGAS[524]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0011); //0018#TVAR_ash_pGAS[525]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A); //0014#TVAR_ash_pGAS[526]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0009); //0019#TVAR_ash_pGAS[527]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000F); //0028#TVAR_ash_pGAS[528]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0018); //0041#TVAR_ash_pGAS[529]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0022); //0067#TVAR_ash_pGAS[530]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0035); //009D#TVAR_ash_pGAS[531]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0043); //00DA#TVAR_ash_pGAS[532]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0055); //00DF#TVAR_ash_pGAS[533]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004B); //00AA#TVAR_ash_pGAS[534]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //007A#TVAR_ash_pGAS[535]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0031); //0058#TVAR_ash_pGAS[536]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0027); //0041#TVAR_ash_pGAS[537]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F); //0034#TVAR_ash_pGAS[538]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0018); //002F#TVAR_ash_pGAS[539]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0018); //0034#TVAR_ash_pGAS[540]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001B); //0043#TVAR_ash_pGAS[541]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023); //005C#TVAR_ash_pGAS[542]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A); //0081#TVAR_ash_pGAS[543]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //00B7#TVAR_ash_pGAS[544]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049); //00F0#TVAR_ash_pGAS[545]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0058); //0106#TVAR_ash_pGAS[546]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D); //00D4#TVAR_ash_pGAS[547]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C); //00A6#TVAR_ash_pGAS[548]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042); //0083#TVAR_ash_pGAS[549]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0038); //006C#TVAR_ash_pGAS[550]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //005E#TVAR_ash_pGAS[551]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D); //005A#TVAR_ash_pGAS[552]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002B); //005F#TVAR_ash_pGAS[553]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002E); //006C#TVAR_ash_pGAS[554]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033); //0085#TVAR_ash_pGAS[555]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003B); //00AB#TVAR_ash_pGAS[556]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0051); //00DE#TVAR_ash_pGAS[557]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0051); //0119#TVAR_ash_pGAS[558]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004B); //0130#TVAR_ash_pGAS[559]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x006C); //00FC#TVAR_ash_pGAS[560]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062); //00D3#TVAR_ash_pGAS[561]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0055); //00B2#TVAR_ash_pGAS[562]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //009B#TVAR_ash_pGAS[563]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0047); //008F#TVAR_ash_pGAS[564]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042); //0089#TVAR_ash_pGAS[565]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F); //008C#TVAR_ash_pGAS[566]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F); //0099#TVAR_ash_pGAS[567]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F); //00B2#TVAR_ash_pGAS[568]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046); //00D4#TVAR_ash_pGAS[569]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0052); //0105#TVAR_ash_pGAS[570]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0036); //0142#TVAR_ash_pGAS[571]
	...
	// CWF
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0204); //01C8#TVAR_wbt_pBaseCcms[54]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF58); //FF7F#TVAR_wbt_pBaseCcms[55]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFD1); //FFE4#TVAR_wbt_pBaseCcms[56]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF48); //FF64#TVAR_wbt_pBaseCcms[57]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F7); //01B2#TVAR_wbt_pBaseCcms[58]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF0E); //FF35#TVAR_wbt_pBaseCcms[59]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFC3); //FFDF#TVAR_wbt_pBaseCcms[60]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFD1); //FFE9#TVAR_wbt_pBaseCcms[61]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F2); //01BD#TVAR_wbt_pBaseCcms[62]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0138); //011C#TVAR_wbt_pBaseCcms[63]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0135); //011B#TVAR_wbt_pBaseCcms[64]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF0F); //FF43#TVAR_wbt_pBaseCcms[65]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01BA); //019D#TVAR_wbt_pBaseCcms[66]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF08); //FF4C#TVAR_wbt_pBaseCcms[67]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F4); //01CC#TVAR_wbt_pBaseCcms[68]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF7); //FF33#TVAR_wbt_pBaseCcms[69]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0199); //0173#TVAR_wbt_pBaseCcms[70]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0147); //012F#TVAR_wbt_pBaseCcms[71]
	// D50
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x031B); //awbb_IndoorGrZones_m_BGrid[2] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x037B); //awbb_IndoorGrZones_m_BGrid[3] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02DF); //awbb_IndoorGrZones_m_BGrid[4] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0355); //awbb_IndoorGrZones_m_BGrid[5] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x029E); //awbb_IndoorGrZones_m_BGrid[6] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0334); //awbb_IndoorGrZones_m_BGrid[7] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0283); //awbb_IndoorGrZones_m_BGrid[8] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0312); //awbb_IndoorGrZones_m_BGrid[9] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0265); //awbb_IndoorGrZones_m_BGrid[10]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02F6); //awbb_IndoorGrZones_m_BGrid[11]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0245); //awbb_IndoorGrZones_m_BGrid[12]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02DC); //awbb_IndoorGrZones_m_BGrid[13]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x022D); //awbb_IndoorGrZones_m_BGrid[14]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02BB); //awbb_IndoorGrZones_m_BGrid[15]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0217); //awbb_IndoorGrZones_m_BGrid[16]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02AA); //awbb_IndoorGrZones_m_BGrid[17]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0203); //awbb_IndoorGrZones_m_BGrid[18]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x029B); //awbb_IndoorGrZones_m_BGrid[19]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01EF); //awbb_IndoorGrZones_m_BGrid[20]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x028E); //awbb_IndoorGrZones_m_BGrid[21]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01E1); //awbb_IndoorGrZones_m_BGrid[22]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0286); //awbb_IndoorGrZones_m_BGrid[23]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01CD); //awbb_IndoorGrZones_m_BGrid[24]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0272); //awbb_IndoorGrZones_m_BGrid[25]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C7); //awbb_IndoorGrZones_m_BGrid[26]
...
//	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //#Tune_TP_AvMoveToGamutDist
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[149]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[253]
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	S5K5CAGX_PV_Mode(0);
#if defined(SIMCOM_FOR1T)//maliyan
