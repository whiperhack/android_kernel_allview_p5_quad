...
#define ALSPS_GET_PS_THD              _IOR(ALSPS, 0x14, int)
#define ALSPS_SET_PS_CALI  		_IOW(ALSPS, 0x15, int)
#define ALSPS_GET_PSRAW_FOR_CALI  		_IOR(ALSPS, 0x16, int)
#define ALSPS_GET_ALS_RAW_DATA2  	_IOR(ALSPS, 0x17, int)
