...
extern int _mtk_wcn_stp_parser_data(UINT8 *buffer, UINT32 length);
extern void _mtk_wcn_stp_set_bluez(MTK_WCN_BOOL sdio_flag);
extern int _mtk_wcn_stp_register_tx_event_cb(int type, MTK_WCN_STP_EVENT_CB func);
extern int _mtk_wcn_stp_register_event_cb(int type, MTK_WCN_STP_EVENT_CB func);
extern int _mtk_wcn_stp_register_if_tx(ENUM_STP_TX_IF_TYPE stp_if, MTK_WCN_STP_IF_TX func);
extern int _mtk_wcn_stp_register_if_rx(MTK_WCN_STP_IF_RX func);
