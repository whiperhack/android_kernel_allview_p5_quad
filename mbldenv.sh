...
export JAVA_HOME=/home/whiper/jdk1.7.0_60


# Overwrite ANDROID_JAVA_HOME environment variable setting if already exists
export ANDROID_JAVA_HOME=/home/whiper/jdk1.7.0_60


# Overwrite PATH environment setting for JDK & arm-eabi if already exists
export PATH=/home/whiper/jdk1.7.0_60/bin:$PWD/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.6/bin:$PATH
